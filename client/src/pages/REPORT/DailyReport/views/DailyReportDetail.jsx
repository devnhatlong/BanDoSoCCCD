            ...
            try {
                ...
                if (reportResponse.data) {
                    setReportData({
                        ...
                        department: reportResponse.data.department || 'CÔNG AN TỈNH LAM ĐỒNG',
                        subDepartment: reportResponse.data.subDepartment || 'PHÒNG THAM MƯU',
                        securityBorderContent: reportResponse.data.securityBorderContent || '',
                        securityFieldsContent: reportResponse.data.securityFieldsContent || '',
                        socialOrderContent: reportResponse.data.socialOrderContent || '',
                        nationalSecurityWork: reportResponse.data.nationalSecurityWork || '',
                        crimeInvestigationWork: reportResponse.data.crimeInvestigationWork || '',
                        otherWork: reportResponse.data.otherWork || '',
                        partyBuildingWork: reportResponse.data.partyBuildingWork || '',
                        suggestions: reportResponse.data.suggestions || ''
                    });
                }
                ...
                antdMessage.error('Không thể tải báo cáo');
            } finally {
                setLoading(false);
            }
        };
